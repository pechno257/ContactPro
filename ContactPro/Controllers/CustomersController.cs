...
namespace ContactPro.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            return View(db.Customers.OrderBy(Customer => Customer.CompanyName).ToList());
        }
        ...
        public ActionResult Edit([Bind(Include = "ID,CompanyName,XceleratorURL,Phone,Fax,Country,Street,City,State,Zip,IsHosted,HostedServer")] Customer customer)
        {
            if (ModelState.IsValid)
            {
                ...
                db.Entry(customer).Property(c => c.DateAdded).IsModified = false;
                db.Entry(customer).Property(c => c.AddedBy).IsModified = false;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(customer);
